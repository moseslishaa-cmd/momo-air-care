...
export function DidYouKnowPopup({ triggerRef }: { triggerRef: React.RefObject<HTMLDivElement | null> }) {
        ...
        <>
          ...
          <motion.div
            ...
            style={{
              ...
              overflow: 'hidden',
              boxShadow: '0 0 0 1.5px rgba(255,212,0,0.35), 0 40px 100px rgba(0,0,0,0.8)',
          ...
          >
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                <span style={{ fontFamily: "var(--font-oswald), sans-serif", fontWeight: 700, fontSize: '0.78rem', letterSpacing: '0.22em', textTransform: 'uppercase', color: '#111' }}>
                  Did You Know?
                </span>
              </div>
            ...
            <div style={{ display: 'flex', flexDirection: isMobile ? 'column' : 'row', alignItems: 'stretch', minHeight: isMobile ? 'auto' : '360px' }}>
              ...
              <div style={{
                ...
                background: `
                  radial-gradient(circle at 50% 40%, rgba(255,212,0,0.45) 0%, rgba(255,212,0,0) 60%),
                  linear-gradient(180deg, rgba(0,0,0,0.42), rgba(0,0,0,0.60)),
                  repeating-linear-gradient(45deg, #FFD400 0px, #FFD400 26px, #141414 26px, #141414 52px)
                `,
              ...
              <div style={{
                ...
                <div>
                  <div style={{
                    ...
                    fontSize: isMobile ? '3.4rem' : '5.2rem', lineHeight: 1, color: '#FFD400',
                  ...
                  <div style={{
                    ...
                    <span style={{ color: '#FFD400' }}>DIRTY DRYER VENT WAS THE CAUSE.</span>
                  </div>
                </div>

                {/* Divider */}
                <div style={{ height: '1px', background: 'linear-gradient(90deg, rgba(255,212,0,0.4), transparent)' }} />
                ...
                <p style={{
                  ...
                  One clogged vent. One spark. <span style={{ color: '#FFD400', fontWeight: 800 }}>Your home is gone forever.</span> It takes one phone call to prevent it — and MOMO does it for just <span style={{ color: '#FFD400', fontWeight: 800, fontSize: '1.1em' }}>$69!</span>
                </p>
                ...
                <a
                  ...
                  style={{
                    ...
                    boxShadow: '0 6px 24px rgba(255,212,0,0.4)',
                    transition: 'transform 0.15s, box-shadow 0.15s',
                    alignSelf: isMobile ? 'stretch' : 'flex-start',
                  }}
                  onMouseEnter={e => { e.currentTarget.style.transform = 'translateY(-2px)'; e.currentTarget.style.boxShadow = '0 10px 32px rgba(255,212,0,0.55)'; }}
                  onMouseLeave={e => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 6px 24px rgba(255,212,0,0.4)'; }}
                >
                ...
                <button onClick={close} style={{
                  ...
                  textAlign: 'left', padding: 0, fontFamily: "var(--font-inter), sans-serif",
                }}>
