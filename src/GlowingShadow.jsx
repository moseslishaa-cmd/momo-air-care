const css = `
  ...
  @keyframes text-3d {
    ...
    25%       { transform: perspective(400px) rotateX(6deg) rotateY(-4deg); }
    50%       { transform: perspective(400px) rotateX(0deg) rotateY(6deg); }
    75%       { transform: perspective(400px) rotateX(-4deg) rotateY(2deg); }
  }
  ...
  .glow-content:before {
    ...
    background: hsl(0deg 0% 16%) radial-gradient(
      ...
      #ffffff calc(0% * var(--bg-size)),
      #eeeeee calc(20% * var(--bg-size)),
      #ffffff calc(40% * var(--bg-size)),
      transparent 100%
    );
  ...
  @keyframes gold-silver-blob {
    0%, 100% { background: #FFD700; }
    25%       { background: #FFF8DC; }
    50%       { background: #C0C0C0; }
    75%       { background: #E8E0A0; }
  }

  @keyframes gold-silver-border {
    0%, 100% { filter: hue-rotate(0deg); }
    50%       { filter: hue-rotate(180deg) saturate(0.3) brightness(1.5); }
  }
`;
