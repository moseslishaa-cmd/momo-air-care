          ...
          <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : 'repeat(3, 1fr)', gap: isMobile ? '12px' : '18px' }}>
            {WARNING_SIGNS.map(w => (
              <div key={w.title} style={{
                ...
                <div>
                  <h4 style={{ fontFamily: "'Inter', sans-serif", fontWeight: 800, fontSize: '0.98rem', color: '#111111', margin: '0 0 4px' }}>{w.title}</h4>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : 'repeat(2, 1fr)', gap: isMobile ? '10px' : '14px' }}>
            {BENEFITS.map(b => (
              <div key={b.title} style={{
                ...
                <div>
                  <h4 style={{ fontFamily: "'Inter', sans-serif", fontWeight: 800, fontSize: '0.95rem', color: '#111111', margin: '0 0 3px' }}>{b.title}</h4>
